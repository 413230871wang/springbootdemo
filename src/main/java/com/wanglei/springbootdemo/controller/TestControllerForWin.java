...
public class TestControllerForWin {

    public static void main(String[] args) throws Exception{
        //获取所有pdf文件路径的list
        LinkedList<File> fileList = PdfProcessUtil.folderMethod1("D:\\pythonData\\pdfData\\1",".pdf");
        int sumRows = 0;
...
//        String pattern = "[0-9]+\\..*?[0-9]+\\;.*?\\.";
            ...
            if (!goalFile.exists()) {
                WriteExcelUtilForWin.createExcelXls(fileDir, sheetName, title);

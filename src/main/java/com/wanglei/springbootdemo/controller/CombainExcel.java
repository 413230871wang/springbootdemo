...
public class CombainExcel {
    ...
    public CombainExcel(String createFilePath, String path) {
        this.createFilePath = createFilePath;
        this.dirPath = path;
    }


    public CombainExcel(String createFilePath, String path, int beginMergerRow) {
        this.createFilePath = createFilePath;
        this.dirPath = path;
        this.beginMergerRow = beginMergerRow;
    }

    public CombainExcel(String createFilePath, String path, int beginMergerColumnIndex, int endMerGerColumnIndex,
                               int beginMergerRow) {
        this.createFilePath = createFilePath;
        this.dirPath = path;

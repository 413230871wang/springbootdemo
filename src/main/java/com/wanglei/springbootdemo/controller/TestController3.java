...
public class TestController3 {
    public static void main(String[] args) throws Exception{
        File file = new File("/Users/mfhj-dz-001-068/pythonData/getFromPdf/guide/蔡/32064ZN0126.pdf");
...
//        String pattern = "[0-9]+\\..*?[0-9]+\\;.*?\\.";
        ...
        //开始写文件
        String fileDir = "/Users/mfhj-dz-001-068/pythonData/guideReferences/writeExcel.xls";

...
public class TestControllerMac1 {

    public static void main(String[] args) throws Exception{
        //获取所有pdf文件路径的list
        LinkedList<File> fileList = PdfProcessUtil.folderMethod1("/Users/mfhj-dz-001-068/pythonData/getFromPdf/guide/麻醉",".pdf");
...
//        String pattern = "[0-9]+\\..*?[0-9]+\\;.*?\\.";
                ...
                //开始写文件
                String fileDir = "/Users/mfhj-dz-001-068/pythonData/guideR/" + fileName + ".xls";
                ...
                if (!goalFile.exists()) {
                    ...
                    WriteExcelUtilForWin.writeToExcelXls(fileDir, "1", list, sumRows);
                }
                return list.size();
            }
        }catch (Exception e){

...
public class TestControllerForWord {

    public static void main(String[] args) throws Exception{
        //获取所有pdf文件路径的list
        LinkedList<File> fileList = PdfProcessUtil.folderMethod1("D:\\pythonData\\pdfData\\1",".docx");
...
//        String pattern = "[0-9]+\\..*?[0-9]+\\;.*?\\.";
            ...
            //开始写文件
            String fileDir = "D:\\pythonData\\"+parentFilename+fileName+".xls";

...
public class WriteExcelUtilForWin {
    ...
    public static void writeToExcelXls(String fileDir, String sheetName, List<Map<String,String>> mapList,int sumRows) throws Exception{
        ...
        try {
            ...
            if(titleRow!=null){
                for(int rowId = 0; rowId < mapList.size(); rowId++){
                    ...
                    HSSFRow newRow=sheet.createRow(sumRows+rowId+1);
